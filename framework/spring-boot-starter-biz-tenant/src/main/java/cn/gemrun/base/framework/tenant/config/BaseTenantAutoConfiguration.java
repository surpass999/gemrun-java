package cn.gemrun.base.framework.tenant.config;

import cn.gemrun.base.framework.common.biz.system.tenant.TenantCommonApi;
...
import cn.gemrun.base.framework.redis.config.BaseCacheProperties;
...
import cn.gemrun.base.framework.tenant.core.aop.TenantIgnoreAspect;
import cn.gemrun.base.framework.tenant.core.db.TenantDatabaseInterceptor;
import cn.gemrun.base.framework.tenant.core.job.TenantJobAspect;
import cn.gemrun.base.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import cn.gemrun.base.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import cn.gemrun.base.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import cn.gemrun.base.framework.tenant.core.redis.TenantRedisCacheManager;
import cn.gemrun.base.framework.tenant.core.security.TenantSecurityWebFilter;
import cn.gemrun.base.framework.tenant.core.service.TenantFrameworkService;
import cn.gemrun.base.framework.tenant.core.service.TenantFrameworkServiceImpl;
import cn.gemrun.base.framework.tenant.core.web.TenantContextWebFilter;
import cn.gemrun.base.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "base.tenant", value = "enable", matchIfMissing = true) // 允许使用 base.tenant.enable=false 禁用多租户
